...
export const SearchBar = () => {
  ...
  return (
    <form onSubmit={handleSearch} className="w-full max-w-sm sm:max-w-lg mx-auto relative">
        ...
        <PopoverTrigger asChild>
          ...
          >
            <div className="flex items-center p-1 sm:p-1.5">
              <Search className="text-muted-foreground ml-1.5 sm:ml-2 mr-2 sm:mr-3" size={11} />
              <Input
                value={searchValue}
                readOnly
                placeholder="Search Sameer's portfolio..."
                className="flex-1 bg-transparent border-none focus:ring-0 focus:outline-none focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-xs sm:text-sm text-foreground placeholder:text-muted-foreground"
              />
              <div className="flex items-center gap-1 mr-1">
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="p-0 h-4 w-4 sm:p-0.5 sm:h-5 sm:w-5 hover:bg-card/50 transition-smooth"

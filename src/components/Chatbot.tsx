...
export const Chatbot = ({ isEmailOpen }: { isEmailOpen?: boolean }) => {
  ...
  return (
    <div style={{ transform: 'scale(0.7)', transformOrigin: 'bottom right' }} className="fixed bottom-4 right-4 w-full max-w-xs sm:max-w-md md:max-w-lg h-[85vh] sm:h-[90vh] bg-card/95 backdrop-blur-md border border-border/30 rounded-2xl z-50 flex flex-col">
      {/* Header */}
